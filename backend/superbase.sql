-- =============================================================
-- TALLER DE SABORES — Base de datos completa
-- Copiar y pegar todo en MySQL Workbench → Execute
-- =============================================================

-- Limpiar tablas existentes (orden por dependencias FK)
...
INSERT INTO pasteles (id, nombre, descripcion, precio, estilo, tamaño, imagen_url, stock, categoria_id) VALUES
